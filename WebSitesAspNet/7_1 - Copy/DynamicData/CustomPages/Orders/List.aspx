...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2 class="DDSubHeader"><%= table.DisplayName%>
        <asp:Label ID="Label1" runat="server" Text="Custom page template"></asp:Label>
    </h2>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                RowStyle-CssClass="td" HeaderStyle-CssClass="th" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <HeaderStyle BackColor="#507CD1" CssClass="th" Font-Bold="True" ForeColor="White"></HeaderStyle>

                <PagerStyle CssClass="DDFooter" BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                <PagerTemplate>
                    <asp:GridViewPager runat="server" />
                </PagerTemplate>
                <RowStyle BackColor="#EFF3FB" CssClass="td"></RowStyle>
