...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ObjectDataSource ID="sourceEmployee" runat="server" SelectMethod="GetEmployee" UpdateMethod="UpdateEmployee"
            ...
            <asp:DetailsView ID="DetailsView2" runat="server"
                DataSourceID="sourceEmployee" Height="50px" Width="125px" AutoGenerateEditButton="true" />
        </div>
    </form>
</body>
</html>
